...
target = Target(num_points_=23,exe_path_=os.path.join(os.path.abspath(os.path.dirname(__file__)),"printtokens","source.alt"),target_name_="print_tokens")   
...
def createPopulation(self):
    # 从文件中读取初始种子
    for p in os.listdir("./seeds"):
        path_ = os.path.join(os.path.abspath("./"),p)
